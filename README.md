...
For now, the program is able to plot the results of the Quadratic family Q<sub>c</sub> (z) = z<sup>2</sup> + c.

The program plots correctly the Full Julia Sets K<sub>c</sub> of the iteration of said functions, as well as the parameter spaces for said family,
given an arbitrary starting point z. This process is sped up by the use of the OpenCL library.
...
<img src="results/Windmills.png" width="400"> <img src="results/Mandelbrot.png" width="400">
...
<img src="results/Swirls.png" width="400"> <img src="results/Dendrite.png" width="400">

### Backwards Iteration Method

<img src="results/Dendrite_BI.png" width="400"> <img src="results/Julia_0_26.png" width="400">
